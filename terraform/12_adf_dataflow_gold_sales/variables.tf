...
variable "airline_source_dataset_name" {
  type        = string
  description = "Dataset name for airline delta source"
  default     = null
}

variable "bookings_source_dataset_name" {
  type        = string
  description = "Dataset name for bookings delta source"
  default     = null
}

variable "airline_source_dataset_name_prefix" {
  type        = string
  description = "Prefix for airline delta source dataset name"
  default     = "ds_silver_airline_delta"
}

variable "bookings_source_dataset_name_prefix" {
  type        = string
  description = "Prefix for bookings delta source dataset name"
  default     = "ds_silver_bookings_delta"
}
